                  ...
                  >
                    ...
                    {expandida && (
                      <div className="p-4">
                        ...
                        <div className="mb-4">
                          <h4 className="text-sm font-semibold text-gray-700 mb-2">Descripción del proyecto</h4>
                          <div className="bg-gray-50 p-3 rounded-lg">
                            <p className="text-sm text-gray-700 leading-relaxed">
                              {notif.descripcionProyecto}
                            </p>
                          </div>
                        </div>
                        ...
                        {/* Estado del proyecto */}
                        <div className="mb-4">
                          <h4 className="text-sm font-semibold text-gray-700 mb-2">Estado del proyecto</h4>
                        ...
                        <div className="space-y-3">
                          <button className="w-full px-4 py-2 bg-[#1A3D7C] text-white rounded-lg hover:bg-[#0f2a5a] transition-colors shadow-sm text-sm font-semibold flex items-center gap-2 justify-center">
                            <FaCalendar />
                            Solicitar una cita
                          </button>
                          ...
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                              console.log('Botón dashboard clickeado para proyecto:', notif._id);
                              console.log('Proyectos disponibles:', proyectos.length);
                              // Buscar el proyecto completo para pasarlo al dashboard
                              const proyectoCompleto = proyectos.find(p => p._id === notif._id);
                              console.log('Proyecto encontrado:', proyectoCompleto);
                              if (proyectoCompleto) {
                                setSelectedProyectoForDashboard(proyectoCompleto);
                                setDashboardOpen(true);
                              }
                            }}
                            className="w-full px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors shadow-sm text-sm font-semibold flex items-center gap-2 justify-center"
                          >
                            <FaTachometerAlt />
